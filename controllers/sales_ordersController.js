...
update: async function (req, res) {
    ...
    if (sales_orders != null) {
        // update
        sales_orders.company_name = req.body.company_name ? req.body.company_name : sales_orders.company_name;
			sales_orders.item_type = req.body.item_type ? req.body.item_type : sales_orders.item_type;
			sales_orders.item_name = req.body.item_name ? req.body.item_name : sales_orders.item_name;
			sales_orders.item_qty = req.body.item_qty ? req.body.item_qty : sales_orders.item_qty;
			sales_orders.item_rate = req.body.item_rate ? req.body.item_rate : sales_orders.item_rate;
