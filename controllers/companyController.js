...
module.exports = {
  ...
  update: async function (req, res) {
    ...
    if (company != null) {
      ...
      company.area_of_company = req.body.area_of_company
        ? req.body.area_of_company
        : company.area_of_company;
      company.person_to_contact = req.body.person_to_contact
        ? req.body.person_to_contact
        : company.person_to_contact;
      company.customer_type = req.body.customer_type
        ? req.body.customer_type
        : company.customer_type;
      company.customer_grade = req.body.customer_grade
        ? req.body.customer_grade
        : company.customer_grade;
      company.customer_history = req.body.customer_history
        ? req.body.customer_history
        : company.customer_history;
      company.customer_history_with_euro = req.body.customer_history_with_euro
        ? req.body.customer_history_with_euro
        : company.customer_history_with_euro;
      company.mass_mailling = req.body.mass_mailling
        ? req.body.mass_mailling
        : company.mass_mailling;
      company.diwali_gift = req.body.diwali_gift
        ? req.body.diwali_gift
        : company.diwali_gift;
      company.ladoo_gift = req.body.ladoo_gift
        ? req.body.ladoo_gift
        : company.ladoo_gift;
      company.other_gift = req.body.other_gift
        ? req.body.other_gift
        : company.other_gift;
      company.send_sample_catalogue = req.body.send_sample_catalogue
        ? req.body.send_sample_catalogue
        : company.send_sample_catalogue;
      company.sample_catalouge_type = req.body.sample_catalouge_type
        ? req.body.sample_catalouge_type
        : company.sample_catalouge_type;
      company.sample_catalouge_data = req.body.sample_catalouge_data
        ? req.body.sample_catalouge_data
        : company.sample_catalouge_data;
      company.first_visited = req.body.first_visited
        ? req.body.first_visited
        : company.first_visited;
      company.next_visit = req.body.next_visit
        ? req.body.next_visit
        : company.next_visit;
